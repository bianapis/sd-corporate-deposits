...
/**
 * CorporateDepositsCorporateDepositsWithIdAndRoot
 */
public class CorporateDepositsCorporateDepositsWithIdAndRoot   {
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: corporate deposit account unique identifier 
