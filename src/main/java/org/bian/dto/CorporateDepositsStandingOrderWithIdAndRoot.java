...
/**
 * CorporateDepositsStandingOrderWithIdAndRoot
 */
public class CorporateDepositsStandingOrderWithIdAndRoot   {
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Standing Order Facility Reference 
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: e.g. start date, end, period, number/cycles 
